...
<section class="content">
  <div class="row">
    <div class="col-md-4">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title" style="padding-left: 37%">PROACTIVE</h3>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-8">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title" style="padding-left: 45%">PROPASSIVE</h3>
        </div>
      </div>
    </div>
  </div> 
                    ...
                    <tbody>
                      ...
                      <td style="max-width: 9px; text-align: left; ">
                        <span style="font-size: 16px; color: #cc00cc">  {{$proactives0 + $proactives1 + $proactives2 + $proactives3}} 
                          ...
                          @elseif($proactives0 + $proactives1 + $proactives2 + $proactives3 != null)
                          <td style=" max-width: 5px; text-align: left;">
                            <span class="text-green">
                              <i class="fa fa-chevron-right" style="font-size: 13px"></i>
                            </span>
