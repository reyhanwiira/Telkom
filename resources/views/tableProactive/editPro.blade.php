              ...
              <div class="box box-primary">
                ...
                {!! csrf_field() !!}
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label>Segment</label>
                      <select class="form-control" name="segment" value="{{ $proactive->segment }}">
            ...
            <div class="form-group">
              ...
              <textarea id="editor1" class="form-control" rows="3" cols="80" placeholder="Enter ..." name="description" value="{{ $proactive->description }}"></textarea>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="currentProgress" value="{{ $proactive->currentProgress }}">
                    ...
                    <label>Start Project</label>
                      <div class="input-group">
                       <div class="input-group-addon">
                        ...
                        <input type="text" class="form-control pull-right" id="reservation" name="startProject" value="{{ $proactive->startProject }}" />
                      </div><!-- /.input group -->
                    </div><!-- /.form group -->
                    ...
                    <label>Finish Project</label>
                      <div class="input-group">
                       <div class="input-group-addon">
                        ...
                        <input type="text" class="form-control pull-right" id="reservation" name="finishProject" value="{{ $proactive->finishProject }}" />
                      </div><!-- /.input group -->
                    </div><!-- /.form group -->
