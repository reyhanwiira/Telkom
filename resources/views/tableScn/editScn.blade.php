...
<body>
  <section class="content">
          ...
          <form role="form" method="post" action="{{ url('/tableScn/'.$scn->id) }}">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <select class="form-control select2" name="status" style="width: 100%;">
                  <option value="P0" <?php if($scn['status']=="P0") echo 'selected="selected"'; ?>>P0</option>
                  <option value="P1" <?php if($scn['status']=="P1") echo 'selected="selected"'; ?>>P1</option>
                  <option value="P2" <?php if($scn['status']=="P2") echo 'selected="selected"'; ?>>P2</option>
                  <option value="P3" <?php if($scn['status']=="P3") echo 'selected="selected"'; ?>>P3</option>
                </select>
              </div>
            ...
            scn
             ...
             <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Enter ..." name="AMSegment" value="{{$scn ->AMSegment}}" />
            </div>

            <div class="form-group">
              <label>Keahlian</label>
              <input type="text" class="form-control" placeholder="Enter ..." name="keahlian" value="{{$scn ->keahlian}}" />
            </div>

            <div class="form-group">
              <label>Est Revenue</label>
              <input type="text" class="form-control" placeholder="Enter ..." name="EstRevenue" value="{{$scn ->EstRevenue}}" />
            </div>

            <div class="form-group">
              <label>Deliverable</label>
              <input type="text" class="form-control" placeholder="Enter ..." name="deliverable" value="{{$scn ->deliverable}}" />
            </div>

            <div class="form-group">
              <label>Benefit</label>
              <input type="text" class="form-control" placeholder="Enter ..." name="benefit" value="{{$scn ->benefit}}" />
            </div>

            <div class="form-group">
              <label>Support AP</label>
              <input type="text" class="form-control" placeholder="Enter ..." name="supportAP" value="{{$scn ->supportAP}}" />
            </div>
              ...
              <tr>
                ...
                <td>
                 <div class="btn-group">
                  ...
                  <a href="{{ url('/deleteActScn/'.$activity->id) }}" onclick="return confirm('Are you sure?')"><button type="button" class="btn btn-danger" data-toggle="tooltip" data-placement="right" title="Delete"><i class='glyphicon glyphicon-trash' style="font-size: 12px"></i></button></a>
    ...
    <div class="box-footer clearfix">
      ...
      <a href="{{ url('tableScn/addActScn') }}" class="btn btn-primary pull-left">New Activity</a>
