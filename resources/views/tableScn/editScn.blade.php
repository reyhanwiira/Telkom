            ...
            <div class="box-body">
              ...
              <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="currentProgress" value="{{ $scn->currentProgress }}">
               ...
               <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter ..." name="AMSegment" value="{{ $scn->AMSegement }}" />
              </div>
