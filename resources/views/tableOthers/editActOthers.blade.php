  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <!-- form start -->
        <form role="form" method="post" action="{{ url('/editActOthers/'.$activity->id) }}">
         {{ method_field('PUT') }}
            {!! csrf_field() !!}
          <div class="box-body">
            ...
            <div class="form-group">
                 ...
                 <div class="input-group">
                   ...
                   <input type="date" class="form-control pull-right" id="reservation" name="tanggal" value="{{ $activity->tanggal }}" />
                 </div><!-- /.input group -->
               </div><!-- /.form group -->
