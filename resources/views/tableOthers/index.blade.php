         ...
         <table id="example4" class="table table-bordered table-striped" style="border-color: black">
          <thead>
            <tr>
              ...
              <th style="width: 10%; border-color: black ; border-bottom-width: 0px; background-color:#ff3333; color: #ffffff">Last Action</th>
              <th style="width: 50%; border-color: black; border-bottom-width: 0px; background-color:#ff3333; color: #ffffff">Next Action</th>
